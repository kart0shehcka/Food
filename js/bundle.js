...
function calc() {
	...
	function getDynamicInformarion(selector) {
	...
	getDynamicInformarion('#height');
	getDynamicInformarion('#weight');
	getDynamicInformarion('#age');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({ container, slide, nextArrow, prewArrow, totalCounter, currentCounter, wrapper, filed }) {
	...
	slidesFiled.style.transition = '.5s all';
...
window.addEventListener('DOMContentLoaded', () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-12-12');
